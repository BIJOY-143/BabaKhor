...
os.system('espeak -a 300 " Welcome,   to,  Draco  Tools  Bijoy"')
...
def crack(idf,pwv):
    ...
    # 'cookie': 'datr=ctwgZgvOdcwhzXVdWAaO0RZk; sb=ctwgZh-X_SzHpttIUjGXLWVo; m_pixel_ratio=1.7004296779632568; wd=423x795; fr=0fK2OFwXsFDK5aqQV..BmINxy..AAA.0.0.BmINyd.AWV5699qIAU',
    'dpr': '2',
